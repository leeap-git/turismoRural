            ...
            <div className="flex-1 space-y-6">
              <div className="flex items-center gap-4">
                <Button variant="outline" size="icon" asChild>
                  <Link href="/dashboard/empreendedor/propriedades">
                ...
                <TabsContent value="informacoes">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Dados básicos que aparecerão no perfil público</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea 
                          id="descricao" 
                          rows={5}
                          defaultValue="A Fazenda Bela Vista oferece uma experiência única de turismo rural no interior de São Paulo."
                        />
                      </div>
                      ...
                      <div className="grid gap-4 md:grid-cols-3">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="preco">Preço/noite (R$)</Label>
                          <Input id="preco" type="number" defaultValue="350" />
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                ...
                <TabsContent value="fotos">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Adicione fotos atraentes (mínimo 4 fotos)</CardDescription>
                    </CardHeader>
                    <CardContent>
